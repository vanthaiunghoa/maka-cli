...
module.exports.setupNpm = function setupNpm(opts) {
  ...
  this.logWarn('[!] It looks like you either just cloned this, or some how misplaced your node_modules folder.  Reinstalling npm deps.');
  this.logWarn('[...] Breathe in -- this will take a moment -- breath out. :D');
...
module.exports.invokeMeteorCommand = function invokeMeteorCommand(cmd, args) {
  ...
  var modulesExist = fs.existsSync(process.env['PWD'] + '/app/node_modules');
  if (!modulesExist && cmd !== 'npm') {
