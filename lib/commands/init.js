...
Command.create({
  ...
  if (config.engines.ssr === 'true') {
    ...
    ignore = ['app/imports/startup/lib/templates.js.jsx', 'app/imports/startup/lib/routes.js.jsx'];
  }
  ...
  return CurrentConfig.withValue(config, function () {
    ...
    if (config.engines.theme === 'material') {
      self.installNpmPackage('material-ui@^1.0.0-beta.17', {cwd: appDirectory, isSelfTest: isSelfTest});
      self.installNpmPackage('material-ui-icons@^1.0.0-beta.17', {cwd: appDirectory, isSelfTest: isSelfTest});
